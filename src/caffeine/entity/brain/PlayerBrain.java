...
public class PlayerBrain extends InteractiveBrain {
  ...
  public PlayerBrain(Game g, Entity self, InputHandler i) {
    ...
    actionMap.put(KeyEvent.VK_UP, new Action[] { new Move(map, Direction.NORTH),
        Face.NORTH });
    actionMap.put(KeyEvent.VK_DOWN, new Action[] { new Move(map, Direction.SOUTH),
        Face.SOUTH });
    actionMap.put(KeyEvent.VK_LEFT, new Action[] { new Move(map, Direction.WEST),
        Face.WEST });
    actionMap.put(KeyEvent.VK_RIGHT, new Action[] { new Move(map, Direction.EAST),
        Face.EAST });
