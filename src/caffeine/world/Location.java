...
public class Location {
  ...
  public Map map() {
    return Location.realm.get(mapID);
  }
  ...
  /**
   * Returns a boolean representing whether or not this location exists within
   * the width and height of the board.
   * 
   * @return boolean representing whether or not this location exists within the
  ...
  /**
   * Returns a reference to a new location determined by projecting this
   * location in the given direction by the given distance.
   * 
   * @param direction
   *          of projection
   * @param distance
  ...
  /**
   * Returns a reference to a new location with the same mapID, x-coordinate and
   * y-coordinate.
   * 
  ...
  /**
   * Changes the state of this location to appear similar to the given location. <br />
   * Useful to take advantage of shared references between other objects to this
   * location object.
   * 
   * @param location
   *          to mimic.
